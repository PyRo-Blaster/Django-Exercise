...
export_model_as_csv.short_description = u'导出为csv文档'
...
class CandidateAdmin(admin.ModelAdmin):
    ...
    #筛选条件
    list_filter = ('city','first_result','first_interviewer_user','second_result','second_interviewer_user','hr_result')
    ...
    fieldsets = (
        ...
        ('第二轮专业面试记录', {'fields':("second_score", ("second_learning_ability", "second_professional_competency", "second_pursue_of_excellence", "second_communication_ability", "second_pressure_score"), "second_advantage", "second_disadvantage", ("second_result", "second_recommend_position"), ("second_interviewer_user", "second_remark"),)}),
        ('HR最终面试记录', {'fields':("hr_score", ("hr_responsibility", "hr_communication_ability", "hr_logic_ability", "hr_potential", "hr_stability"), "hr_advantage", "hr_disadvantage", "hr_result", ("hr_interviewer_user", "hr_remark"),)}),
    )
