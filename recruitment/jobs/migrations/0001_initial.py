    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.SmallIntegerField(choices=[(0, '技术类'), (1, '产品类'), (2, '运营类'), (3, '设计类')], verbose_name='岗位类型')),
                ('job_name', models.CharField(max_length=250, verbose_name='岗位名称')),
                ...
                ('job_requirement', models.TextField(max_length=1024, verbose_name='岗位需求')),
